...
public interface Constants {
	...
	public static final String REDIS_KEY_PREFIX_MEMBER_COMPANY_ID = "member:company_id";
	 ...
	 * 超级用户ID
	 */
	public static final int FISE_SUPPER_ACCOUNT_ID = 2;                    
	
	/**
	 * 权限可见状态
	 */
	public static final Integer PERMISSION_STATU_VISIBLE = 1;          
}
