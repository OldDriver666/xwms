...
public class EventServiceImpl implements IEventService {
    ...
    public Response query(EventQueryParam param) {
        ...
        List<IMEvent> eventList = eventDao.selectByExample(tableName, example2);
        resp.success(eventList);
        return resp;
    }
