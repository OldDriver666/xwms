$(function() {
	...
	var action = {
		...
		loadPageData : function() {
            ...
            var search_parentName = $("#input-search-parentname").val();

            var url = ctx + "boss/depart/queryDepartmentByPage";
            var data = {
                "page_no": 1,
                "page_size": 10,
                "param": {
                    "departName": search_name,
    ...
    $("#input-search-parentname").on('keydown', function(e) {
        if (e.keyCode == 13) {
            action.loadPageData();
        }
    });
