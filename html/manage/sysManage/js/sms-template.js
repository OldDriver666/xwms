$(function() {
	...
	var action = {
		...
		loadPageData : function() {
            var search_keywords = $("#input-search-keywords").val();
            var url = ctx + "boss/sms/queryIMSmsTemplateByPage";
            var data = {
                "page_no": 1,
                "page_size": 10,
                "param": {
                    "action_name": search_keywords
                }
            };
            var opt = {
	...
	$("#input-search-keywords").on('keydown', function(e) {
		if (e.keyCode == 13) {
			action.loadPageData();
		}
