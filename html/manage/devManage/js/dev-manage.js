$(function() {
	...
	var action = {
		...
		add : function() {
            ...
            param.DeviceIME = $("#input-devIME").val();
            param.DeviceXW = $("#input-devXW").val();
            param.DepartId = parseInt(depart_id);
            param.ProductType = parseInt($("#input-devType").val());
		...
		//编辑数据
		edit : function() {
            var url = ctx + "FiseDeviceManage/ModifyDeviceInfo";
            var data = new Object();
            data.UserName = userName;
            data.AuthenticCode = token_value;
            data.DeviceId = parseInt($("#input-id").val());
            data.DeviceIME = $("#input-devIME").val();
            data.DeviceXW = $("#input-devXW").val();
    ...
    $("#pageContent").on("click",".table-edit-btn",function(){
        ...
        $("#input-phoneNo").val(that.find("td").eq(5).text());
